...
Person level is open to any role. A Team-level Objective SHALL reference its
Team explicitly, and an Objective MAY reference a higher Objective in the same
Organization.
